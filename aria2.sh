...
Download_aria2() {
    ...
    DOWNLOAD_URL="https://mirror.ghproxy.com/https://github.com/P3TERX/Aria2-Pro-Core/releases/download/${aria2_new_ver}/aria2-${aria2_new_ver%_*}-static-linux-${ARCH}.tar.gz"
    {
...
Download_aria2_conf() {
    PROFILE_URL1="https://mirror.ghproxy.com/https://raw.githubusercontent.com/P3TERX/aria2.conf/master/"
...
Service_aria2() {
    if [[ ${release} = "centos" ]]; then
        wget -N -t2 -T3 "https://mirror.ghproxy.com/https://raw.githubusercontent.com/P3TERX/aria2.sh/master/service/aria2_centos" -O /etc/init.d/aria2 ||
        ...
        wget -N -t2 -T3 "https://mirror.ghproxy.com/https://raw.githubusercontent.com/P3TERX/aria2.sh/master/service/aria2_debian" -O /etc/init.d/aria2 ||
...
crontab_update_start() {
    ...
    echo -e "\n0 7 * * * /bin/bash <(wget -qO- https://mirror.ghproxy.com/https://raw.githubusercontent.com/P3TERX/aria2.conf/master/tracker.sh) ${aria2_conf} RPC 2>&1 | tee ${aria2_conf_dir}/tracker.log" >>"/tmp/crontab.bak"
...
Update_bt_tracker() {
    ...
    check_pid
    [[ -z $PID ]] && {
        bash <(wget -qO- https://mirror.ghproxy.com/https://raw.githubusercontent.com/P3TERX/aria2.conf/master/tracker.sh) ${aria2_conf}
    } || {
        bash <(wget -qO- https://mirror.ghproxy.com/https://raw.githubusercontent.com/P3TERX/aria2.conf/master/tracker.sh) ${aria2_conf} RPC
    }
}
Update_aria2() {
    check_installed_status
